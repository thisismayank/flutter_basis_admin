...
class LeftPanelFrontPage extends StatefulWidget {
  const LeftPanelFrontPage(
      {Key? key,
  ...
  @override
  State<LeftPanelFrontPage> createState() => _LeftPanelFrontPageState();
}

class _LeftPanelFrontPageState extends State<LeftPanelFrontPage> {
  @override
  void initState() {
